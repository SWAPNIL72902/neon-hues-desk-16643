    ...
    <section className="min-h-screen flex items-center justify-center gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 rounded-full bg-primary/20 backdrop-blur-sm text-primary border border-primary/30 text-sm font-medium mb-4">
              Final Year @ BITS Pilani
            </span>
          </div>
          
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
            Hi, I'm <span className="gradient-text">Swapnil Pahari</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-12">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-primary/50 text-foreground bg-background/50 hover:bg-primary hover:text-primary-foreground backdrop-blur-sm transition-all duration-300 hover:scale-105"
              asChild
            >
